...
# UPDATE RUN-UPDATE
cd /usr/bin
wget -O run-update "https://raw.githubusercontent.com/${GitUser}/hasilsenip/main/update/run-update.sh"
chmod +x run-update
# RUN UPDATE
echo ""
clear
...
sleep 2
cd /usr/bin
wget -O update "https://raw.githubusercontent.com/${GitUser}/hasilsenip/main/update/update.sh"
wget -O run-update "https://raw.githubusercontent.com/${GitUser}/hasilsenip/main/update/run-update.sh"
wget -O message-ssh "https://raw.githubusercontent.com/${GitUser}/hasilsenip/main/update/message-ssh.sh"
wget -O change-port "https://raw.githubusercontent.com/${GitUser}/hasilsenip/main/change.sh"
wget -O system "https://raw.githubusercontent.com/${GitUser}/hasilsenip/main/menu/system.sh"
